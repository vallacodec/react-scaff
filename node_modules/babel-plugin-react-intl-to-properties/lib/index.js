        ...
        visitor: {
            Program: {
                ...
                exit: function exit(path, state) {
                    ...
                    var propertiesFilePath = getMessagesFilePath(messagesDir, fileName);
                    ...
                    if (messagesDir && descriptors.length > 0) {
                        ...
                        (0, _fs.writeFileSync)(propertiesFilePath, '');
                        ...
                        descriptors.forEach(function (descriptor) {
                            ...
                            var cleanedMessage = defaultMessage.replace(/\s+/g, ' ');
                            var cleanedDescription = description.trim().replace(/\s+/g, ' ');
                        ...
                        (0, _from2.default)(translations.keys()).sort().forEach(function (key) {
                            var _translations$get = translations.get(key);

                            var value = _translations$get.value;
                            var comment = _translations$get.comment;

                            var formattedDescription = ('# ' + comment + '\n                                ' + key + ' = ' + value + '\n                                ').replace(/^\s+/gm, ''); // Dedent string
                            (0, _fs.appendFileSync)(propertiesFilePath, formattedDescription);
                        });
                    }
                }
            },
...
var translations = new _map2.default();